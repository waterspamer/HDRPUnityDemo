...
[Obsolete("Use ScreenSaver instead this")]
public class DeprecatedScreenSaver : MonoBehaviour {
    ...
    [ConfigField("Idle Time Before Start")]
    ...
    private void ShowScreensaver() {
        ...
        _objToHide.Clear();
        var objsWithTag = GameObject.FindGameObjectsWithTag("ScreenSaverHide");
